...
def DecryptFile (passphrase, filein, fileout):
    ...
    FILEOUT = io.open(fileout, 'w', encoding='utf-8')
...
##    file2=io.open(fileout, "r", encoding='utf-8')
##    print("The decrypted message for the ciphertext is:\n%s\n" % file2.read())
##    file2.close()

def main():
    if len(sys.argv) !=4:#takes in three arguments for the inputfile, outputfile names and "passphrase"
        sys.exit("Error, DecryptFile takes three arguments for the inputfile, outputfile names and passphrase")
    DecryptFile (setPassPhrase(sys.argv[3]), sys.argv[1], sys.argv[2])
